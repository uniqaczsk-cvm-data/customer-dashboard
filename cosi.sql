...
SELECT  distinct a.contractnumber
       ...
       ,a.flow_type
       ,b.ContractNumber
FROM dw_cvm.dbo.mn_nni_all_1 a
LEFT JOIN
(
	SELECT  contractnumber
	       ,idsubject
...
ON a.ContractNumber = b.ContractNumber AND a.idObject = b.idObject AND a.idSubject = b.idSubject AND a.month_id = b.month_id
WHERE a.flow_type = 1
AND a.idsubject = '36402123'
SELECT  *
FROM dw_cvm.dbo.mn_nni_all
WHERE ContractNumber = '9140065496'
ORDER BY start_dt, flow_type asc